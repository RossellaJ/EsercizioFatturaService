...
public class FatturaServiceServiceLocator extends org.apache.axis.client.Service implements it.alfasoft.rossella.FatturaServiceService {
    ...
    private java.lang.String FatturaService_address = "http://localhost:8085/EsercizioFatturaSoap/services/FatturaService";
    ...
    public it.alfasoft.rossella.FatturaService getFatturaService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.alfasoft.rossella.FatturaServiceSoapBindingStub _stub = new it.alfasoft.rossella.FatturaServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.alfasoft.rossella.FatturaService.class.isAssignableFrom(serviceEndpointInterface)) {
                it.alfasoft.rossella.FatturaServiceSoapBindingStub _stub = new it.alfasoft.rossella.FatturaServiceSoapBindingStub(new java.net.URL(FatturaService_address), this);
                _stub.setPortName(getFatturaServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://rossella.alfasoft.it", "FatturaServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://rossella.alfasoft.it", "FatturaService"));
        }
